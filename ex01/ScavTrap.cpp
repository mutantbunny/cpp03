...
/*   Updated: 2023/11/21 01:34:09 by gmachado         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap(void): ClapTrap("Unnamed", default_hp,
	default_ep, default_damage)
{
	std::cout << "ScavTrap default constructor called." << std::endl;
}

ScavTrap::ScavTrap(std::string name): ClapTrap(name, default_hp,
	default_ep, default_damage)
{
